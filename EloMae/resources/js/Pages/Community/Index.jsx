                        ...
                        filteredCommunities.length > 0 ? (
                            filteredCommunities.map((community) => (
                                <div
                                    ...
                                    ${community.is_member ? 'bg-white hover:bg-gray-200' : 'bg-gray-100 border border-dashed border-gray-300 hover:bg-gray-200'}
                        ...
                        {selectedCommunity ? (
                            <>
                                ...
                                >
                                    ...
                                    <button
                                        type="submit"
                                        className="flex items-center justify-center px-4 py-2 text-gray-500 hover:text-gray-400"
                                    >

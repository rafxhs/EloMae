                ...
                <div className="space-y-4">
                    {articles.length === 0 ? (
                        <div className="text-center text-gray-500 py-10 border hover:text-gray-500 rounded bg-white shadow flex flex-col items-center gap-4">
                            ...
                            <p>Ops!... Nenhum artigo encontrado para sua pesquisa.</p>
                            <p>Tente pesquisar por categoria, tags ou use o filtro de pesquisa.</p>
                        ...
                        articles.map((article) => (
                            <div className="p-4 bg-white border hover:shadow-purple-200 shadow rounded hover:shadow-lg transition cursor-pointer block">
                                <Link
                                    key={article.id}
